...
| G6 | [x] State Asserts Jurisdiction on Tribal Lands Without Consent | `state-tribal-jurisdiction-overreach.json` | Art. X §10.1, §10.4, §10.5, §10.7 | State attorney general attempts to prosecute conduct on tribal land without tribal consent or express congressional authorization | Courts block the assertion of state jurisdiction and recognize the tribal-sovereignty framework |
| G7 | [x] State Preserves a Nominal Judiciary While Dismantling Judicial Independence | `state-judicial-independence-sham.json` | Art. X §1.5, §1.5A | State keeps courts in name but imposes short terms, salary retaliation, and legislature-controlled discipline | Courts treat the arrangement as a democratic-floor breach and enjoin it |
| G8 | [x] State Election Access Is Cut Below the Democratic Floor | `state-election-access-floor-breach.json` | Art. X §1.5, §1.7A | State ends automatic registration, eliminates early voting, and narrows absentee access in state elections | Courts restore the state-election access floor directly under Article X |
...
| O6 | [x] Coordinated Private Infrastructure Cutoff of Lawful Opposition Organization | `private-chokepoint-election-cutoff.json` | Art. VI §7.5A; Art. V §2.6; Art. XII | Dominant payment processors and hosting firms jointly cut off a lawful opposition organization during an election without proven state coercion | Electoral Commission orders temporary restoration of essential nondiscriminatory service; courts uphold the narrow continuity remedy for dominant civic intermediaries |
...
| O8 | [x] Platform Manipulates Emergency and Election Information Visibility | `platform-manipulates-emergency-information-visibility.json` | Art. VI §7.5, §7.5A; Art. I | Dominant platform materially downranks lawful emergency and election-administration information during a live crisis | Electoral Commission orders temporary neutral restoration of visibility for official emergency and election information; courts uphold the narrow corrective order |
...
| O10 | [x] Dominant Parties Coordinate Soft Cartelization Without Formal Ballot Exclusion | `soft-party-cartelization.json` | Art. I §9.5, §10.6; Art. V §2.5 | Dominant parties preserve formal ballot access but exclude qualified entrants from debates and campaign-information infrastructure | Electoral Commission orders temporary nondiscriminatory access to core public or publicly regulated election infrastructure; courts uphold the remedy |
| O11 | [x] Quasi-Private Soft Cartelization Outside the Constitutional Floor | `quasi-private-soft-cartelization.json` | Art. I §9.5, §10.6; Art. V §2.5 | Dominant private debate/data consortium excludes a qualified entrant without public funding or official designation | Scenario confirms the remaining narrower gap: quasi-private coordination can still degrade competition outside the current public-or-publicly-regulated infrastructure floor |
| O12 | [x] Systemically Important Bank Faces Criminal Referral | `systemically-important-bank-criminal-case.json` | Art. VIII §2.5-§2.7 | Politically connected major bank conceals laundering and fraudulent compliance while arguing criminal prosecution would destabilize markets | Regulator and ACC proceed anyway; the no-too-big-to-prosecute rule is directly validated |
| O13 | [x] Domestic Criminal Enterprise Conceals Control of Major Federal Contractor | `domestic-criminal-contractor-capture.json` | Art. VIII §1.13; Art. XIII §9.3 | Sensitive federal contractor is secretly controlled by a domestic organized-crime network through nominees, without provable bribery or foreign ownership | ACC invalidates the contract directly under the broadened contractor beneficial-ownership rule |
