...
| Article VIII — Government Ethics | 9.0 | Near-final | Strong anti-corruption architecture; §2.10 revolving-door machinery collapsed from 8 sub-subsections to one section with four lettered principles; §§2.7–2.9 consolidated into a single Congressional mandate | Article is now solidly at 9.0 rather than held there by detailed sub-provisions; draft discipline is now 9.2 | Final whole-draft consistency pass; verify no overlap with Art XIII on independent agency structure |
...
| Article VIII — Government Ethics | 8.8 | 9.0 | 9.0 | 8.8 | 9.5 | 9.2 | 9.0 |
