...
| Article XII — Constitutional Organs | 8.0 | Strong | Narrow oversight bodies remain a good design choice and the transition fallback now prevents organ-setup delay from becoming an open institutional gap | Still the most cross-reference-dependent article in the draft, and organ constitution remains a live deadline bottleneck even with the Article XIX bridge | Reduce cross-reference dependence and compress commission detail |
