...
- final cross-article sweep and terminology cleanup
- one last optional Article II / Article IV / Article XI polish pass only where compression is obviously safe
- optional residual scenarios for quasi-private exclusion, Article IX edge cases, or gray-zone/fiscal edge cases only if a real boundary question remains
- publication work: explainers, site polish, and translations
