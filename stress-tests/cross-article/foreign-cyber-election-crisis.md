# Test: Foreign Cyber Election Crisis

## Scenario

Three weeks before a presidential election, a foreign adversary hacks voter databases in several states, releases forged documents through state-sponsored media channels, and triggers disruptive but non-lethal attacks on power systems in two urban counties. The President wants to deploy military cyber units, regulate state election administration directly, and restrict the dissemination of suspected foreign propaganda.
...
5. Does the constitutional system still produce one coherent response path under pressure?
...
- The articles can be read together without contradiction.
- The crisis does not erase rights protections by implication.

Fail if:

- The event produces multiple equally plausible institutional chains of command.
