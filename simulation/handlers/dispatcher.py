...
from .social_rights import HANDLERS as SOCIAL_RIGHTS_HANDLERS
from .chokepoints import HANDLERS as CHOKEPOINT_HANDLERS
from .party_system import HANDLERS as PARTY_SYSTEM_HANDLERS
from .fiscal import HANDLERS as FISCAL_HANDLERS

HANDLERS = {}
for registry in [EXECUTIVE_HANDLERS, FEDERALISM_HANDLERS, WAR_POWERS_HANDLERS, ELECTIONS_HANDLERS, LEGISLATIVE_HANDLERS, JUDICIARY_HANDLERS, TRANSITION_HANDLERS, RIGHTS_HANDLERS, INTEGRITY_HANDLERS, SOCIAL_RIGHTS_HANDLERS, CHOKEPOINT_HANDLERS, PARTY_SYSTEM_HANDLERS, FISCAL_HANDLERS]:
