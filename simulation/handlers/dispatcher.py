...
HANDLERS = {}
for registry in [EXECUTIVE_HANDLERS, FEDERALISM_HANDLERS, WAR_POWERS_HANDLERS, ELECTIONS_HANDLERS, LEGISLATIVE_HANDLERS, JUDICIARY_HANDLERS, TRANSITION_HANDLERS, RIGHTS_HANDLERS, INTEGRITY_HANDLERS, SOCIAL_RIGHTS_HANDLERS, CHOKEPOINT_HANDLERS, PARTY_SYSTEM_HANDLERS]:
